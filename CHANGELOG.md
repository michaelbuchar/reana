...
## [0.95.0](https://github.com/michaelbuchar/reana/compare/0.9.4...0.95.0) (2026-08-19)
...
* **helm:** bump Redis cache image from 5.0.5 to 8.6.3 ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([f9416fb](https://github.com/michaelbuchar/reana/commit/f9416fb3534a76ed31608a473387df7c35192277))
* **helm:** upgrade PgBouncer to 1.24.1 ([#907](https://github.com/michaelbuchar/reana/issues/907)) ([d449404](https://github.com/michaelbuchar/reana/commit/d449404768de015a0d47da67d7aee4339849ba76))


### Features

* **config:** add new reana-demo-lhcb-run2-b2jpsik example ([#928](https://github.com/michaelbuchar/reana/issues/928)) ([c90496a](https://github.com/michaelbuchar/reana/commit/c90496ac5a825e804c99a2db3bde98b1ff1823a7))
* **helm:** add configurable UI security headers ([#945](https://github.com/michaelbuchar/reana/issues/945)) ([9fe2c49](https://github.com/michaelbuchar/reana/commit/9fe2c49b1e6e6d7fc43c5ac4f1d4eaf1ee752263))
* **helm:** add configurable workspace listing limits ([#900](https://github.com/michaelbuchar/reana/issues/900)) ([cdcaa96](https://github.com/michaelbuchar/reana/commit/cdcaa96c957c65fa046fa54447fa6b55e7899b1b))
* **helm:** add controller uWSGI ConfigMaps ([#953](https://github.com/michaelbuchar/reana/issues/953)) ([ecdaffc](https://github.com/michaelbuchar/reana/commit/ecdaffc4e80d437b2e8099d093ffed2d24625a93))
* **helm:** add EOSC SSO authentication option ([#911](https://github.com/michaelbuchar/reana/issues/911)) ([9ad4b4a](https://github.com/michaelbuchar/reana/commit/9ad4b4ad1dfaf6b61df2f029bb7b617594e8da9e))
* **helm:** add k8s resource request/limits for infra components ([#889](https://github.com/michaelbuchar/reana/issues/889)) ([865bd99](https://github.com/michaelbuchar/reana/commit/865bd998547755f1e3e97133639917f30c8ac99f))
* **helm:** add Kueue scheduling option for user workloads ([#903](https://github.com/michaelbuchar/reana/issues/903)) ([02053cf](https://github.com/michaelbuchar/reana/commit/02053cfb10762877fd5dfe236713548334984b20)), closes [#800](https://github.com/michaelbuchar/reana/issues/800)
* **helm:** add new component reana-dask-kubernetes-operator ([#891](https://github.com/michaelbuchar/reana/issues/891)) ([909d2e0](https://github.com/michaelbuchar/reana/commit/909d2e070fbb22e7dd81c562d42108a5760cd63b))
* **helm:** add quota management secret configuration ([#908](https://github.com/michaelbuchar/reana/issues/908)) ([301fc2a](https://github.com/michaelbuchar/reana/commit/301fc2a962a6401eb730ebaace455b7f3f0df9a2))
* **helm:** add quota period Helm support ([#931](https://github.com/michaelbuchar/reana/issues/931)) ([37af266](https://github.com/michaelbuchar/reana/commit/37af266f60ad2fd11cdc7a7add4417313b9e1f57))
* **helm:** add token management secret configuration ([#950](https://github.com/michaelbuchar/reana/issues/950)) ([fe71ab3](https://github.com/michaelbuchar/reana/commit/fe71ab361986f3e215e1bf0509886e4e0ce8f8c9))
* **helm:** add value to customise vetted container images ([#902](https://github.com/michaelbuchar/reana/issues/902)) ([207b10f](https://github.com/michaelbuchar/reana/commit/207b10f9aba3064a8ca546bf36e119f2e9fc8ef6))
* **helm:** allow automatic access token issuance ([#927](https://github.com/michaelbuchar/reana/issues/927)) ([4d85bc1](https://github.com/michaelbuchar/reana/commit/4d85bc10b679044a181e960aa0a40a8a8bd35549)), closes [#925](https://github.com/michaelbuchar/reana/issues/925)
* **helm:** allow configuring number of threads for Dask workers ([#877](https://github.com/michaelbuchar/reana/issues/877)) ([3e3dc24](https://github.com/michaelbuchar/reana/commit/3e3dc24646f94f6b4ba83346e979938c83e1a0fe)), closes [#874](https://github.com/michaelbuchar/reana/issues/874)
* **helm:** allow custom session lifetime ([#937](https://github.com/michaelbuchar/reana/issues/937)) ([2ea8abf](https://github.com/michaelbuchar/reana/commit/2ea8abf4cd1e56b97ffe7ba62daa06a344ea20d4))
* **helm:** allow customising minimum Kubernetes job user ID ([#956](https://github.com/michaelbuchar/reana/issues/956)) ([1cd83ab](https://github.com/michaelbuchar/reana/commit/1cd83abcbbc76cecca8b33e6bdb53a8c3a7985b1))
* **helm:** allow only reana-server to connect to reana-cache ([#847](https://github.com/michaelbuchar/reana/issues/847)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** collect logs from Dask pods ([#850](https://github.com/michaelbuchar/reana/issues/850)) ([06fa887](https://github.com/michaelbuchar/reana/commit/06fa887e1e8aa3c99058ae4c5a6c6491337cefa2))
* **helm:** enrich disabled local development configuration ([#983](https://github.com/michaelbuchar/reana/issues/983)) ([798a5ca](https://github.com/michaelbuchar/reana/commit/798a5caba211fe68052ac280c37c251295721d22))
* **helm:** increase default rate limit to 40 requests per second ([#890](https://github.com/michaelbuchar/reana/issues/890)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **helm:** increase default rate limit to 40 requests per second ([#890](https://github.com/michaelbuchar/reana/issues/890)) ([e377407](https://github.com/michaelbuchar/reana/commit/e377407a85329d2b609900bd8457b1d92eee7299))
* **helm:** introduce `node_label_infrastructurewc` Helm value ([#885](https://github.com/michaelbuchar/reana/issues/885)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **helm:** introduce `node_label_infrastructurewc` Helm value ([#885](https://github.com/michaelbuchar/reana/issues/885)) ([4aac8f4](https://github.com/michaelbuchar/reana/commit/4aac8f49419ba452679cd48cd5027c3597c94df5))
* **helm:** introduce `traefik.external` Helm chart value ([#866](https://github.com/michaelbuchar/reana/issues/866)) ([b2074bc](https://github.com/michaelbuchar/reana/commit/b2074bc7b261ec7aa7eefc40590b6dd94905cc8c)), closes [#852](https://github.com/michaelbuchar/reana/issues/852)
* **helm:** introduce resource requests and limits for job pods ([#888](https://github.com/michaelbuchar/reana/issues/888)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **helm:** introduce resource requests and limits for job pods ([#888](https://github.com/michaelbuchar/reana/issues/888)) ([15ca171](https://github.com/michaelbuchar/reana/commit/15ca1719594830a90f45002208e050b3c9f99102)), closes [#883](https://github.com/michaelbuchar/reana/issues/883)
* **helm:** pass vetted image policy to job controllers ([#970](https://github.com/michaelbuchar/reana/issues/970)) ([c31f587](https://github.com/michaelbuchar/reana/commit/c31f5870c4a0928cd5e19772b1119cdcabe73fe2))
* **helm:** release check on most-supported Kubernetes version ([#848](https://github.com/michaelbuchar/reana/issues/848)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** remove default GitLab host ([#938](https://github.com/michaelbuchar/reana/issues/938)) ([eac01cb](https://github.com/michaelbuchar/reana/commit/eac01cb0e277079431442849a7b6839c91f6f728))
* **helm:** replace FLASK_ENV with FLASK_DEBUG for debug mode ([#946](https://github.com/michaelbuchar/reana/issues/946)) ([83df5a9](https://github.com/michaelbuchar/reana/commit/83df5a97ef01320a49c3cbf6db5747cfff7843fa))
* **helm:** roll all affected deployments when secrets change ([#923](https://github.com/michaelbuchar/reana/issues/923)) ([048bb40](https://github.com/michaelbuchar/reana/commit/048bb4054f847cf1031dfba423ad578f8d1bed20))
* **helm:** support fsGroup-based shared storage access ([#984](https://github.com/michaelbuchar/reana/issues/984)) ([df18220](https://github.com/michaelbuchar/reana/commit/df182201cc578db8773e5cb2a8f7733278dbd9bb))
* **helm:** support password-protected rabbitmq ([#847](https://github.com/michaelbuchar/reana/issues/847)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** support password-protected redis ([#847](https://github.com/michaelbuchar/reana/issues/847)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** support separate runtime namespace for workflow pods ([#955](https://github.com/michaelbuchar/reana/issues/955)) ([2d46c83](https://github.com/michaelbuchar/reana/commit/2d46c83922b289f313ec7b9e8ab600551a60d9db)), closes [#954](https://github.com/michaelbuchar/reana/issues/954)
* **helm:** use a named ACL user for the Redis cache ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([e236d66](https://github.com/michaelbuchar/reana/commit/e236d6617500714e541c925d9f903983fad65167))
* **reana-dev:** add --issue option to git-checkout-pr ([#948](https://github.com/michaelbuchar/reana/issues/948)) ([7d82ed6](https://github.com/michaelbuchar/reana/commit/7d82ed608a12e6b463935de1270cd7242c7ecd4c))
* **reana-dev:** add `--namespace` option to `run-ci` command ([#862](https://github.com/michaelbuchar/reana/issues/862)) ([51c3a11](https://github.com/michaelbuchar/reana/commit/51c3a112c0afd1adeb6f004e986369990630ff5f))
* **reana-dev:** add create-branch option to git-upgrade command ([#958](https://github.com/michaelbuchar/reana/issues/958)) ([d08cb5c](https://github.com/michaelbuchar/reana/commit/d08cb5cb5e6fc4c04bc71e14375df7cdfdc61d19))
* **reana-dev:** add git-iteration-rollover command ([#960](https://github.com/michaelbuchar/reana/issues/960)) ([bc7654e](https://github.com/michaelbuchar/reana/commit/bc7654e5a30248730478152c5d022af5a8f9647b))
* **reana-dev:** add release-docker-copy command ([#919](https://github.com/michaelbuchar/reana/issues/919)) ([219e202](https://github.com/michaelbuchar/reana/commit/219e202790843d378c0d5fc92c64e79b19de8a0f))
* **reana-dev:** add support for pyproject.toml components ([#916](https://github.com/michaelbuchar/reana/issues/916)) ([d475e29](https://github.com/michaelbuchar/reana/commit/d475e29df333001d70f384d8fb381093547da077))
* **reana-dev:** allow using Colima/K3s as an alternative to Kind ([#894](https://github.com/michaelbuchar/reana/issues/894)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **reana-dev:** allow using Colima/K3s as an alternative to Kind ([#894](https://github.com/michaelbuchar/reana/issues/894)) ([ad4cd09](https://github.com/michaelbuchar/reana/commit/ad4cd09078b4f32907d1f22a1a7c86e013f96cde))
* **reana-dev:** auto-create multi-arch release-docker builder ([#959](https://github.com/michaelbuchar/reana/issues/959)) ([aa9f5e5](https://github.com/michaelbuchar/reana/commit/aa9f5e57217f0e0443a3a0b511c3b04b9d1d2b1f))
* **reana-dev:** avoid shell interpolation in git-upgrade command ([#958](https://github.com/michaelbuchar/reana/issues/958)) ([39b3140](https://github.com/michaelbuchar/reana/commit/39b31401d485b433c0403fe0ceeb3ed22cc1ffec))
* **reana-dev:** enhance changelog aggregator for alpha releases ([#921](https://github.com/michaelbuchar/reana/issues/921)) ([73027e0](https://github.com/michaelbuchar/reana/commit/73027e03475211b3b9d15d76e0bacea01a2cac7e))
* **reana-dev:** register reana-datastore-s3fs component ([#979](https://github.com/michaelbuchar/reana/issues/979)) ([ca70738](https://github.com/michaelbuchar/reana/commit/ca707381272c0294d629def3b0e451e08c7bd063))
* **reana-dev:** reuse existing local branch in git-checkout-pr ([#947](https://github.com/michaelbuchar/reana/issues/947)) ([6296b66](https://github.com/michaelbuchar/reana/commit/6296b6628cc664e5db0d77d2e9581a66bcb76a50))
* **reana-dev:** update Dockerfile image.created label on release ([#917](https://github.com/michaelbuchar/reana/issues/917)) ([57ab98f](https://github.com/michaelbuchar/reana/commit/57ab98f9fb0e64e2c3a81bbf08cb10e957f6028f))
* **reana-dev:** use Docker Buildx for multi-arch image releases ([#915](https://github.com/michaelbuchar/reana/issues/915)) ([2e59c41](https://github.com/michaelbuchar/reana/commit/2e59c41f9e610bdefe500fa4280799c05bc3db84))
* **scripts:** upgrade Kueue to v0.17.0 ([#940](https://github.com/michaelbuchar/reana/issues/940)) ([4f2ba90](https://github.com/michaelbuchar/reana/commit/4f2ba905773815d5172376d11347f5f97361f673))
* **scripts:** upgrade to Jupyter SciPy 7.2.2 notebook ([#846](https://github.com/michaelbuchar/reana/issues/846)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))


### Bug fixes

* **config:** use glob for egg-info in flake8 exclude ([#896](https://github.com/michaelbuchar/reana/issues/896)) ([bee69e4](https://github.com/michaelbuchar/reana/commit/bee69e47090e9746a8c071d95a1dfa62485a1141)), closes [#882](https://github.com/michaelbuchar/reana/issues/882)
* **helm:** add disabling of GitLab host via empty string ([#922](https://github.com/michaelbuchar/reana/issues/922)) ([b182726](https://github.com/michaelbuchar/reana/commit/b1827260c6f9aa71d968862d0a046d9574e8b246))
* **helm:** add quota management secret default ([#982](https://github.com/michaelbuchar/reana/issues/982)) ([50d6cd2](https://github.com/michaelbuchar/reana/commit/50d6cd2bdaac4550841917c673f7c26c699d7e77))
* **helm:** allow interactive-session-cleanup job to access RWC ([#853](https://github.com/michaelbuchar/reana/issues/853)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** harmonise REANA host name and port configurations ([#867](https://github.com/michaelbuchar/reana/issues/867)) ([8acfb28](https://github.com/michaelbuchar/reana/commit/8acfb287b916602f8f8f1cedf5d112b545c17300)), closes [#865](https://github.com/michaelbuchar/reana/issues/865)
* **helm:** only mount CERN/EOSC SSO secrets when configured ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([1456eb6](https://github.com/michaelbuchar/reana/commit/1456eb60f51eff1d75f5577f5f7359e6f0dee81d))
* **helm:** only mount GitLab OAuth secrets when configured ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([2b4658c](https://github.com/michaelbuchar/reana/commit/2b4658c11bedc79a642c3a1f1fa547e29cd3c51b))
* **helm:** quote Helm template values consistently ([#939](https://github.com/michaelbuchar/reana/issues/939)) ([32f3d8f](https://github.com/michaelbuchar/reana/commit/32f3d8f95e0099eb1dc5c5b9b1ae6972b4af5f96))
* **helm:** remove null default for quota update policy ([#941](https://github.com/michaelbuchar/reana/issues/941)) ([307584d](https://github.com/michaelbuchar/reana/commit/307584dfb329a3b579610dbcd8523bbecec3f560))
* **helm:** require explicit DB, MQ, cache and OpenSearch secrets ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([bc9303f](https://github.com/michaelbuchar/reana/commit/bc9303f1f5bfee138b94fb9322e3441bb51ed31a))
* **helm:** require explicit REANA_SECRET_KEY ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([b2eeacc](https://github.com/michaelbuchar/reana/commit/b2eeaccd4fbda34708752b176937a35b2ab2300b))
* **helm:** update Traefik chart repository ([#992](https://github.com/michaelbuchar/reana/issues/992)) ([c275bf2](https://github.com/michaelbuchar/reana/commit/c275bf2c254865dc69d9fdaccc94ceb1d90efd8b)), closes [#991](https://github.com/michaelbuchar/reana/issues/991)
* **helm:** use alpha image tag for dask operator ([#942](https://github.com/michaelbuchar/reana/issues/942)) ([10702a9](https://github.com/michaelbuchar/reana/commit/10702a9ded4091dcbd9195e04cac8b4f4a17cf79))
* **helm:** use int64 for large numeric template values ([#941](https://github.com/michaelbuchar/reana/issues/941)) ([c817d7a](https://github.com/michaelbuchar/reana/commit/c817d7ae60f452e4a09702a1c28e721828adac1d))
* **reana-dev:** activate environment using dot-source command ([#965](https://github.com/michaelbuchar/reana/issues/965)) ([08739a9](https://github.com/michaelbuchar/reana/commit/08739a90a512de9b84063ee8afaaa2317402a01d)), closes [#962](https://github.com/michaelbuchar/reana/issues/962)
* **reana-dev:** avoid multi-manifest indices in kind load ([#961](https://github.com/michaelbuchar/reana/issues/961)) ([8eaf55d](https://github.com/michaelbuchar/reana/commit/8eaf55d4e7ed597762c8807eed1f5a4ad7709fc7))
* **reana-dev:** correctly handle missing changelog of components ([#858](https://github.com/michaelbuchar/reana/issues/858)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **reana-dev:** detect versions in git-create-release-commit ([#936](https://github.com/michaelbuchar/reana/issues/936)) ([0243ef7](https://github.com/michaelbuchar/reana/commit/0243ef72afb2d532b388d424f2678c520a790179))
* **reana-dev:** enable `run-example` fallback legacy checks ([#928](https://github.com/michaelbuchar/reana/issues/928)) ([90f1467](https://github.com/michaelbuchar/reana/commit/90f1467f7e31d1d28f408f5d7dbc9ce581069337))
* **reana-dev:** handle multi-match in git-upgrade-shared-modules ([#936](https://github.com/michaelbuchar/reana/issues/936)) ([bc946d5](https://github.com/michaelbuchar/reana/commit/bc946d5c6c2e37b9aba29da12ec02726d47f5f8d))
* **reana-dev:** improve component detection from subdirectories ([#910](https://github.com/michaelbuchar/reana/issues/910)) ([471e5a3](https://github.com/michaelbuchar/reana/commit/471e5a3b6278302a7a2c9d03ff6a512448d66dda))
* **reana-dev:** install all client components in one pip call ([#946](https://github.com/michaelbuchar/reana/issues/946)) ([25e4593](https://github.com/michaelbuchar/reana/commit/25e4593006bb7fefe5519f23f97c966efd334eba))
* **reana-dev:** upgrade shared modules in both setup/pyproject ([#934](https://github.com/michaelbuchar/reana/issues/934)) ([d3ac466](https://github.com/michaelbuchar/reana/commit/d3ac4663802d3abfa3cf50cc96641c616e56703c))
* **reana-dev:** use chore commit scope when bumping dependencies ([#868](https://github.com/michaelbuchar/reana/issues/868)) ([3788789](https://github.com/michaelbuchar/reana/commit/378878948e1fa99e3f2e336cbf5d699753aaa08d))
* **reana-dev:** use correct `--python-tests` flag in tests ([#946](https://github.com/michaelbuchar/reana/issues/946)) ([01a44b9](https://github.com/michaelbuchar/reana/commit/01a44b9b5872531576071a5a77556f66097329f4))
* **reana-dev:** use current PR references in git-checkout-pr ([#988](https://github.com/michaelbuchar/reana/issues/988)) ([e1d4a62](https://github.com/michaelbuchar/reana/commit/e1d4a6246080b3f9c7bc4ed58413079c465da917)), closes [#987](https://github.com/michaelbuchar/reana/issues/987)
* **reana-dev:** use PEP440 version format for reana-client tags ([#920](https://github.com/michaelbuchar/reana/issues/920)) ([17fd87d](https://github.com/michaelbuchar/reana/commit/17fd87d0be04bd27fd65273b14cc5d2639b014d7))


### Performance improvements

* **reana-dev:** check local branches with `git show-ref` ([#969](https://github.com/michaelbuchar/reana/issues/969)) ([35cba20](https://github.com/michaelbuchar/reana/commit/35cba20c2a5814337f09f1fbac5b236095a4f406))
* **reana-dev:** drop `shell=True` from remaining hot paths ([#969](https://github.com/michaelbuchar/reana/issues/969)) ([1758677](https://github.com/michaelbuchar/reana/commit/1758677de9f97a0e29bb9f6ca3c127c5d1f8e88c))
* **reana-dev:** run `git-fetch` components in parallel ([#969](https://github.com/michaelbuchar/reana/issues/969)) ([0050b04](https://github.com/michaelbuchar/reana/commit/0050b049a8b9840e1ca47c284d80b73cacb2ccd2))
* **reana-dev:** speed up git-status on macOS ([#969](https://github.com/michaelbuchar/reana/issues/969)) ([5824e15](https://github.com/michaelbuchar/reana/commit/5824e155b98ea03add5350e813a07516759c9485))


### Code refactoring

* **pytest:** drop pytest-reana and use pytest directly ([#949](https://github.com/michaelbuchar/reana/issues/949)) ([5d681f6](https://github.com/michaelbuchar/reana/commit/5d681f6b2df7b6db530a90f259cfc9a52d5db2fe))


### Code style

* **python:** adapt code base to the new black version ([#921](https://github.com/michaelbuchar/reana/issues/921)) ([ccd3077](https://github.com/michaelbuchar/reana/commit/ccd307742be5c8635e36034ec8903208d60b3f7e))


### Continuous integration

* **commitlint:** fix local running of commit linter on macOS ([#898](https://github.com/michaelbuchar/reana/issues/898)) ([c48d92a](https://github.com/michaelbuchar/reana/commit/c48d92a4e089f61f27302c16e3657a71146d34d7))
* **helm:** configure target branch name for helm linting ([#863](https://github.com/michaelbuchar/reana/issues/863)) ([e2b6037](https://github.com/michaelbuchar/reana/commit/e2b603726ea37a946d0ec09999645861c9e75ce1))
* **helm:** configure target branch name for helm linting ([#885](https://github.com/michaelbuchar/reana/issues/885)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **helm:** configure target branch name for helm linting ([#885](https://github.com/michaelbuchar/reana/issues/885)) ([823f9fc](https://github.com/michaelbuchar/reana/commit/823f9fc80a880176dbbc52d6d3622fb3a12ded8e))
* **python:** pin setuptools below 81 ([#926](https://github.com/michaelbuchar/reana/issues/926)) ([75303e4](https://github.com/michaelbuchar/reana/commit/75303e459011f14eae421feb5236ec4a4c597ab8))
* **run-tests:** add usage help and refactor options ([#930](https://github.com/michaelbuchar/reana/issues/930)) ([5bb9b8d](https://github.com/michaelbuchar/reana/commit/5bb9b8de446e27de0fcdc89f0fce805a81d01783))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#890](https://github.com/michaelbuchar/reana/issues/890)) ([3375dae](https://github.com/michaelbuchar/reana/commit/3375daed3b428bcc0c692dfdaa4ee828eb8f726c))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#890](https://github.com/michaelbuchar/reana/issues/890)) ([dc0cad7](https://github.com/michaelbuchar/reana/commit/dc0cad72aad4fc668beabc67ba57db7901c5e639))


### Documentation

* **helm:** align README with chart secret hardening ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([2d8c86f](https://github.com/michaelbuchar/reana/commit/2d8c86fc5c483f7c18f8fc2a11dfc95e40e91b51))
* **helm:** clarify secrets-related warning in README ([#847](https://github.com/michaelbuchar/reana/issues/847)) ([d9c375f](https://github.com/michaelbuchar/reana/commit/d9c375fb479829a557f1828a6fcbd30f5a533e26))
* **helm:** document all configurable environment variables ([#901](https://github.com/michaelbuchar/reana/issues/901)) ([060c02f](https://github.com/michaelbuchar/reana/commit/060c02f524d52ffd962b953a723a8b3f1946dda0)), closes [#899](https://github.com/michaelbuchar/reana/issues/899)
* **helm:** document REANA_RATELIMIT_SLOWER and SLOWEST ([#966](https://github.com/michaelbuchar/reana/issues/966)) ([fd6609e](https://github.com/michaelbuchar/reana/commit/fd6609e3e4a301def6bc076e6aea9468a1fe0960))
* **helm:** improve Slurm compute backend documentation ([#985](https://github.com/michaelbuchar/reana/issues/985)) ([371ec22](https://github.com/michaelbuchar/reana/commit/371ec2238a328e6d8743e2b71052d4f1b55bd137))


### Chores

* **master:** release 0.95.0-alpha.1 ([251a172](https://github.com/michaelbuchar/reana/commit/251a172977e0eb666d4335809ef43ca692fcfeab))
